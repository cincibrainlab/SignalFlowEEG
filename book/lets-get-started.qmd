...
Before getting invested in a new workflow, I think it's important to understand if the results are a good fit for your laboratory. 
...
5. Use the artifact-free SET to perform analyzses across toolkits but create R-statistics compatible tables.
