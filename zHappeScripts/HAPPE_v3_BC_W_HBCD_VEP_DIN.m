...
filename = which('HAPPE_v3_BC_W_HBCD_ALLrun_DIN.m');
[filepath, ~, ~] = fileparts(filename);
srcDir = strcat(filepath, '\HAPPE_preprocessing_pipeline\HAPPE_BC_W_Processing_VEP')
%srcDir = 'Z:\HBCD\Official_Pilot\HAPPE_preprocessing_pipeline\HAPPE_BC_W_Processing_VEP'
cd (srcDir) ;
...
filename = which('HAPPE_v3_BC_W_HBCD_ALLrun_DIN.m');
[filepath, ~, ~] = fileparts(filename);
paramFile = strcat(filepath, '\HAPPE_preprocessing_pipeline\HAPPE_BC_W_Processing_VEP\input_parameters\params_BC_W_HBCD_VEP_ECG_DIN.mat')
%paramFile = 'Z:\HBCD\Official_Pilot\HAPPE_preprocessing_pipeline\HAPPE_BC_W_Processing_VEP\input_parameters\params_BC_W_HBCD_VEP_ECG_DIN.mat';
load(paramFile)
...
%Z:\Dropboxes\mantunez\HBCD\HAPPE_BC_W_Processing_VEP\input_parameters\params_BC_W_HBCD_VEP_ECG.mat
%Z:\HBCD\Official_Pilot\HAPPE_preprocessing_pipeline\HAPPE_BC_W_Processing_VEP\input_parameters\params_BC_W_HBCD_VEP_ECG_DIN.mat
