...
obj.proj.path_import = '/srv/Analysis/Nate_Projects/Test_Happe_HBCD_Output';
obj.proj.path_temp = '/srv/Analysis/Nate_Projects/';
obj.proj.path_results = '/srv/Analysis/Nate_Projects/Test_Happe_HBCD_Output2';

% Module Information
% obj.module.Modules = {'inflow_ImportSet', 'midflow_LowpassFilter', 'outflow_ExportSet'};
obj.module.Modules = {'inflow_ImportSet','outflow_HappeRejectChannels'};
