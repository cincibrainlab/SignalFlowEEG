...
filename = which('HAPPE_v3_BC_W_HBCD_ALLrun_DIN.m');
[filepath, ~, ~] = fileparts(filename);
srcDir = strcat(filepath, '\HAPPE_preprocessing_pipeline\HAPPE_BC_W_Processing_RS')
%srcDir = 'Z:\HBCD\Official_Pilot\HAPPE_preprocessing_pipeline\HAPPE_BC_W_Processing_RS'
cd (srcDir) ;
...
filename = which('HAPPE_v3_BC_W_HBCD_ALLrun_DIN.m');
[filepath, ~, ~] = fileparts(filename);
paramFile = strcat(filepath, '\HAPPE_preprocessing_pipeline\HAPPE_BC_W_Processing_RS\input_parameters\params_BC_W_HBCD_RS_ECG.mat')
%paramFile = 'Z:\HBCD\Official_Pilot\HAPPE_preprocessing_pipeline\HAPPE_BC_W_Processing_RS\input_parameters\params_BC_W_HBCD_RS_ECG.mat';
load(paramFile)
...
%Z:\Dropboxes\mantunez\HBCD\HAPPE_BC_W_Processing_VEP\input_parameters\params_BC_W_HBCD_VEP.mat
%Z:\Dropboxes\mantunez\HBCD\HAPPE_BC_W_Processing_RS\input_parameters\params_BC_W_HBCD_RS.mat
%Z:\Dropboxes\mantunez\HBCD\HAPPE_BC_W_Processing_RS\input_parameters\params_BC_W_HBCD_RS_ECG.mat
%Z:\HBCD\Official_Pilot\HAPPE_preprocessing_pipeline\HAPPE_BC_W_Processing_RS\input_parameters\params_BC_W_HBCD_RS_ECG.mat
...
if strcmp(task, 'RS')
    ...
    bgin_RS = find(strcmp({EEG.event.type}, 'DIN3'));        
    end_RS = find(strcmp({EEG.event.type}, 'TRSP'));
    Keep_Data = EEG.event(bgin_RS(1):end_RS(2)); 
    EEG.event = Keep_Data
end
